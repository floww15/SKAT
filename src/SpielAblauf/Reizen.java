...
//				if (weg[(pos + 1) % 3]) {
//					clients[(pos + 0) % 3].changesReizen("es wird gedrückt", "", "", "bitte warten", "", "");
...
//			}
			if (ersteRunde && pos == 2 && sagen) {
				...
				clients[1].changesReizen(null, "Weg", "", null, "JA", "hören");
			...
			if (ersteRunde && pos == 1 && !sagen) {
				...
				clients[2].changesReizen(null, "Weg", "", null, "JA", "hören");
				weg[1]=true;
